...
> **Kompaktformat:** Die Einführungspräsentation (`intro-skript.md`) ersetzt
...
Lesen Sie `ausgangsmaterial/projektbriefing.md`. Dies ist die Rohinformation, die Sie
...
- Kopieren Sie den System Prompt aus `werkzeuge/agentenbeispiele/01-stakeholder-analyst.md`
