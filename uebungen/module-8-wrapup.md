...
- Automatisierte Traceability-Pflege in CI/CD (siehe `tools/validate_requirements.py`)

## Ressourcen

- **Dieses Repository:** Referenzlösungen in `docs/`, Agent-Prompts in `workshop/agents/`
