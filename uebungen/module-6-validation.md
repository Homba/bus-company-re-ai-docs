...
1. **Requirements Reviewer** (`workshop/agents/06-requirements-reviewer.md`)
2. **Traceability Checker** (`workshop/agents/07-traceability-checker.md`)
...
> [Inhalt aus docs/07-functional-requirements.md einfügen]
...
**Vergleichen Sie mit** `docs/10-traceability-matrix.md` — die Referenz verfolgt jedes BR
