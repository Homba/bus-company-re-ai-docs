...
`workshop/agents/01-stakeholder-analyst.md`.
...
1. Das Projektbriefing (`workshop/starting-materials/project-brief.md`)
2. Die Interviewprotokolle (`workshop/starting-materials/interview-transcripts.md`)
...
Öffnen Sie `docs/01-stakeholders.md` und vergleichen Sie:
