...
cp ../agentenbeispiele/01-stakeholder-analyst.md CLAUDE.md
claude
...
with open("agentenbeispiele/01-stakeholder-analyst.md") as f:
...
model = genai.GenerativeModel(
    ...
    system_instruction=open("agentenbeispiele/01-stakeholder-analyst.md").read()
)
